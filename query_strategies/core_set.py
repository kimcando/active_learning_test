...
class CoreSet(Strategy):
    def __init__(self, args, X, Y, idxs_lb, net, handler, tr_transform, te_transform, tor=1e-4):
        super(CoreSet, self).__init__(args, X, Y, idxs_lb, net, handler, tr_transform, te_transform)
        self.tor = tor
