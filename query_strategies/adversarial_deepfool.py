...
class AdversarialDeepFool(Strategy):
    def __init__(self, args, X, Y, idxs_lb, net, handler, tr_transform, te_transform, max_iter=50):
        super(AdversarialDeepFool, self).__init__(args, X, Y, idxs_lb, net, handler, tr_transform, te_transform)
