...
class AdversarialBIM(Strategy):
	def __init__(self, args, X, Y, idxs_lb, net, handler, tr_transform, te_transform, eps=0.05):
		super(AdversarialBIM, self).__init__(args, X, Y, idxs_lb, net, handler, tr_transform, te_transform)
		self.eps = eps
