...
class ActiveLearningByLearning(Strategy):
	def __init__(self, args, X, Y, idxs_lb, net, handler, tr_transform, te_transform, delta = 0.1):
		super(ActiveLearningByLearning, self).__init__(args, X, Y, idxs_lb, net, handler, tr_transform, te_transform)
